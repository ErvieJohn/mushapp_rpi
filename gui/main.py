...
class TabButtonLayout(QWidget):
    def __init__(self):
        ...
        self.labelsALL = [self.label6, self.label7, self.label8,  self.label9, self.label10, 
        ...
        if self.arduino_connected:
            ...
            try:
                ...
                if(self.data[slice(10)] == "JSON data:"):
                    ...
                    self.label1.setText('<b><span style="color:black;">Temperature: <span style="color:{};">{}°C</span></span></b>'.format(
                        "green" if fTemp >= 20 and fTemp <= 30 
                        else "orange" if fTemp <= 19 else "red", self.jsonData["temperature"]))
                    self.label2.setText('<b><span style="color:black;">Humidity: <span style="color:{};">{} %</span></span></b>'.format(
