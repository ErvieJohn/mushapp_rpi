...
class TabButtonLayout(QWidget):
    def __init__(self):
        ...
        switchesH1Layout.addWidget(self.switch2, alignment=Qt.AlignRight)
        switchesH1Layout.addStretch(1) 
        switchesH1Layout.addWidget(self.label8)
        switchesH1Layout.addWidget(self.switch3, alignment=Qt.AlignRight)
        switchesH1Layout.addStretch(1) 
        switchesH1Layout.setAlignment(Qt.AlignRight)

        switchesH2Layout = QHBoxLayout()
        switchesH2Layout.addStretch(1) 
        switchesH2Layout.addWidget(self.label9)
        switchesH2Layout.addWidget(self.switch4, alignment=Qt.AlignRight)
        switchesH2Layout.addStretch(1) 
        switchesH2Layout.addWidget(self.label10)
        switchesH2Layout.addWidget(self.switch5, alignment=Qt.AlignRight)
        switchesH2Layout.addStretch(1) 
        switchesH2Layout.setAlignment(Qt.AlignRight)

        switchesH3Layout = QHBoxLayout()
        switchesH3Layout.addStretch(1)
        switchesH3Layout.addWidget(self.label11)
        switchesH3Layout.addWidget(self.switch6, alignment=Qt.AlignRight)
        switchesH3Layout.addStretch(1)
        switchesH3Layout.addWidget(self.label12)
        switchesH3Layout.addWidget(self.switch7, alignment=Qt.AlignRight)
        switchesH3Layout.addStretch(1)
        switchesH3Layout.setAlignment(Qt.AlignRight)
