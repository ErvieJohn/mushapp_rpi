...
class TabButtonLayout(QWidget):
    def __init__(self):
        ...
        switchesH1Layout.addWidget(self.switch2, alignment=Qt.AlignLeft)
        switchesH1Layout.addStretch(1) 
        switchesH1Layout.addWidget(self.label8)
        switchesH1Layout.addWidget(self.switch3, alignment=Qt.AlignLeft)
        switchesH1Layout.addStretch(1) 
        ...
        switchesH2Layout.addWidget(self.switch4, alignment=Qt.AlignLeft)
        switchesH2Layout.addStretch(1) 
        switchesH2Layout.addWidget(self.label10)
        switchesH2Layout.addWidget(self.switch5, alignment=Qt.AlignLeft)
        switchesH2Layout.addStretch(1) 
        ...
        switchesH3Layout.addWidget(self.switch6, alignment=Qt.AlignLeft)
        switchesH3Layout.addStretch(1)
        switchesH3Layout.addWidget(self.label12)
        switchesH3Layout.addWidget(self.switch7, alignment=Qt.AlignLeft)
        switchesH3Layout.addStretch(1)
